...
def preprocess_tweet(tweet):
    ...
    tweet = re.sub(r'\.{2,}', ' ', tweet, flags = re.DOTALL)
...
def preprocess_json(json_file_name, processed_file_name):
    ...
    # open the json file and iterate through each line, use the text and clean it out and save the output in a new file
    ...
    # close the file after reading it and then print the name of the new file
    save_to_file.close()
